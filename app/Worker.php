...
class Worker extends Model
{
     ...
     */
    protected $fillable = [
        'type_worker_id', 'sub_type_worker_id', 'payroll_type_document_identification_id', 'country_id', 'municipality_id', 'type_contract_id', 'high_risk_pension', 'identification_number', 'surname', 'second_surname', 'first_name', 'middle_name', 'address', 'integral_salarary', 'salary', 'worker_code',
    ];
