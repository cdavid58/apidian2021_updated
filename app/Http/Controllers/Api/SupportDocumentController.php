...
//        return $invoice->saveXML();
        ...
        $QRStr = $this->createPDF($user, $company, $seller, $typeDocument, $resolution, $date, $time, $paymentForm, $request, $signInvoice->ConsultarCUFE(), "SUPPORTDOCUMENT", $withHoldingTaxTotal, $notes, $healthfields);
...
//            $holdingTaxTotal = $request->holding_tax_total;
        ...
        $QRStr = $this->createPDF($user, $company, $seller, $typeDocument, $resolution, $date, $time, $paymentForm, $request, $signInvoice->ConsultarCUFE(), "INVOICE", $withHoldingTaxTotal, $notes, $healthfields);

        $invoice_doc->prefix = $resolution->prefix;
        $invoice_doc->seller = $seller->company->identification_number;
        $invoice_doc->xml = "DSS-{$resolution->next_consecutive}.xml";
        $invoice_doc->pdf = "DSS-{$resolution->next_consecutive}.pdf";
        $invoice_doc->client_id = $seller->company->identification_number;
        $invoice_doc->client =  $request->seller ;
