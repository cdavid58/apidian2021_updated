...
//        return $payroll_note->saveXML();
        ...
        $QRStr = $this->createPDFPayroll($user, $company, $predecessor, $period, $worker, $resolution, $payment, $payment_dates, $typeDocument, $notes, $accrued, $deductions, $request, $signPayrollNote->ConsultarCUNE(), "NA");
...
//                if($request->sendmail){
//                    $payroll_note = Document::where('identification_number', '=', $company->identification_number)
...
//        return $payroll_note->saveXML();
        ...
        $QRStr = $this->createPDFPayroll($user, $company, $predecessor, $period, $worker, $resolution, $payment, $payment_dates, $typeDocument, $notes, $accrued, $deductions, $request, $signPayrollNote->ConsultarCUNE(), "PAYROLL");
