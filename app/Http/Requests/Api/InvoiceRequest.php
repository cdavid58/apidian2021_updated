...
class InvoiceRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'customer.phone' => 'required_unless:customer.identification_number,222222222222|numeric|digits_between:7,10',
...
//            'deliveryparty.dv' => 'nullable|required_with:delivery|numeric|digits:1|dian_dv:'.$this->deliveryparty["identification_number"],
            ...
            'deliveryparty.phone' => 'nullable|required_with:deliveryparty|numeric|digits_between:7,10',
