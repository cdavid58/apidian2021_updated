...
class InvoiceLine extends Model
{
     ...
     */
    protected $fillable = [
        'unit_measure_id', 'type_item_identification_id', 'reference_price_id', 'invoiced_quantity', 'line_extension_amount', 'free_of_charge_indicator', 'notes', 'description', 'agentparty', 'agentparty_dv', 'brandname', 'modelname', 'code', 'price_amount', 'base_quantity', 'allowance_charges', 'tax_totals',
    ];
