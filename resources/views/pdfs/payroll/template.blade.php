        ...
        <tr>
            <td class="vertical-align-top" style="width: 45%;">
                <table>
                    ...
                    <tr>
                        <td>Tipo de Trabajardor:</td>
                        <td>{{$worker->type_worker->name}}</td>
                    </tr>
                </table>
            </td>
            <td class="vertical-align-top" style="width: 30%; padding-left: 1rem">
                <table>
                    <tr>
                        <td>Forma de Pago:</td>
        ...
        <tbody>
            ...
            @if(isset($request['accrued']['paid_vacation']))
                ...
                <?php $ItemNro = $ItemNro + 1; ?>
                    <tr>
                        <td>{{$ItemNro}}</td>
                        <td>PAGO DE {{$paid_vacation['quantity']}} DIA(S) DE VACACIONES COMPENSADAS DESDE - {{$paid_vacation['start_date']}} HASTA {{$paid_vacation['end_date']}}</td>
